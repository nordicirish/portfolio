  ...
  return (
    <>
      <Link
        ...
        className="group flex items-center justify-center gap-2 rounded-lg outline-none focus:scale-110 hover:scale-110 hover:bg-blue-900 active:scale-110 transition-transform duration-300 ease-out bg-blue-800 dark:bg-fuchsia-900 dark:hover:bg-fuchsia-950 text-white h-10 sm:h-[3.2rem] px-4 w-2/3 sm:w-auto shadow-lg dark:shadow-md" // Full width on small screens, auto on larger screens
        onClick={() => {
