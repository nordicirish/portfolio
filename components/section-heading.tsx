...
export default function SectionHeading({ children }: SectionHeadingProps) {
  return (
    ...
    <h2 className="max-w-[42rem] w-[42rem] text-3xl font-medium capitalize mb-12 sm:mb-16 mx-auto text-center text-blue-700 dark:text-gray-200 tracking-wide leading-tight px-4 relative">
      {children}
